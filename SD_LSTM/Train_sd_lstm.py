...
from sd_lstm_trainer import SDLSTMDistributionLearner
...
if __name__ == '__main__':
    ...
    args.output_dir = args.output_dir + '/batch_size_' + str(args.batch_size) + '_1'
    ...
    trainer = SDLSTMDistributionLearner(data_set = 'QM9',
